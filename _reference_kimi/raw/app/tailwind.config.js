  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 20px 40px rgba(0, 0, 0, 0.4), 0 0 30px rgba(0, 212, 255, 0.1)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "beam-down": "beam-down 2s ease-out forwards",
        "ping-slow": "ping-slow 3s ease-out infinite",
      },
      backgroundImage: {
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'gradient-hero': 'linear-gradient(135deg, rgba(0, 212, 255, 0.15) 0%, rgba(59, 130, 246, 0.1) 50%, rgba(20, 184, 166, 0.05) 100%)',
      },
    },
  },
